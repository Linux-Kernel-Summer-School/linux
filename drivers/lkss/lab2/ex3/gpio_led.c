...
static ssize_t gpio_led_write(struct file *file, const char __user *buf, size_t count, loff_t *ppos)
{
	...
	/* TODO 3: If user wrote '1', turn LED on */

	/* TODO 3:Otherwise, turn LED off */
...
static ssize_t gpio_led_read(struct file *file, char __user *buf, size_t count, loff_t *ppos)
{
	...
	/* TODO 4: Read actual GPIO value (0 or 1) */

	/* TODO 4: Convert value to string */
...
static int gpio_led_probe(struct platform_device *pdev)
{
	...
	/* TODO 2: Request GPIO associated with device node (default: output low) */
