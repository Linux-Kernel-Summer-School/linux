...
static ssize_t my_read(struct file *file, char __user *buf, size_t len, loff_t *offset)
{
	...
	/* TODO 1: copy_to_user has the format ( * to, *from, size) and returns 0 on success */
...
{
	/* TODO 2: Register the character device and get a dynamic major number */
	/* Check for registration failed */

	/* TODO 2: Log the assigned major number */
...
{
	/* TODO 2: Unregister the character device */
